...
{
    IGeneralPermissionBuilder<TPrincipal, TPermission, TSecurityRole, TPermissionRestriction> SetPermissionPeriod(
    ...
    IGeneralPermissionBuilder<TPrincipal, TPermission, TSecurityRole, TPermissionRestriction> SetCustomPermissionEqualityComparer<TComparer>()
        where TComparer : IPermissionEqualityComparer<TPermission, TPermissionRestriction>;

    IGeneralPermissionBuilder<TPrincipal, TPermission, TSecurityRole, TPermissionRestriction> SetCustomPermissionManagementService<TPermissionManagementService>()
